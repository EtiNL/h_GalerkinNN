...
def num_approx_galerkin(x0, n, hz, ht, Tmax, z_range = (-7.0, 7.0), quadrature_method='adaptive'):
    """
    Compute Burgers solution using Galerkin projection with Hermite basis.
    ...
    assert quadrature_method == 'adaptive', \
        f"Only 'adaptive' quadrature is currently supported in num_approx_galerkin, got '{quadrature_method}'"

    print(f"Using {quadrature_method} quadrature for Galerkin projection")
